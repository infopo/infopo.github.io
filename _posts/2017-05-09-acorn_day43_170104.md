...
touch test.txt     #바로 파일 생성[root@localhost ~]# echo "kkkkk" > test.txt
...
jw is not in the sudoers file. this incident will be reported.
centos
su root
su jw
